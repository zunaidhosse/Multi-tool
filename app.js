...
window.addEventListener('beforeinstallprompt', (e) => {
    ...
    console.log('beforeinstallprompt event fired.'); // ডিবাগিং বার্তা
});
...
if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
        // Service Worker ফাইলের পাথ পরিবর্তন করা হয়েছে
        // এটি ব্রাউজারের রুট ডিরেক্টরি থেকে service-worker.js ফাইলটি খুঁজবে।
        navigator.serviceWorker.register('./service-worker.js') // পাথ পরিবর্তন
            .then((registration) => {
                console.log('Service Worker registered with scope:', registration.scope);
                showMessage('সফল!', 'Service Worker সফলভাবে রেজিস্টার হয়েছে। এখন অ্যাপটি অফলাইনে কাজ করতে পারে।');
            })
            .catch((error) => {
                console.error('Service Worker registration failed:', error);
                showMessage('ত্রুটি', `Service Worker রেজিস্ট্রেশন ব্যর্থ হয়েছে: ${error.message}। অ্যাপের অফলাইন কার্যকারিতা সীমিত হতে পারে।`);
            });
    });
}
